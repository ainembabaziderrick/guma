...
class MemberController extends Controller
{
    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('created_at_date', function ($member) {
                return \Carbon\Carbon::parse($member->created_at)->format('d-m-Y'); // Format created_at as date only
            })
    ...
    public function datas()
    {
     ...
     public function user_member_sub()
    {
        return view('member.sub_index');
    }
