        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action=" {{ url('admin/carousel/update/'.$cases->id)}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field()}}
                        <input type="hidden" name="old_image" value="{{ $cases->image}}">

                                               
                        <div class="row mb-3">
                            <label class = "col-sm-2 col-form-label">Honey Type <span style="color: red;"> *</span>
                            </label>
                            <div class="col-sm-10">
