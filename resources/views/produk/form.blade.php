<div class="modal fade" id="modal-form" tabindex="-1" role="dialog" aria-labelledby="modal-form">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="date" name="expiry_date" id="expiry_date" class="form-control" required autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
    ...
    <div class="col-lg-6">
        <input type="number" name="stok" id="stok" class="form-control" required value="0" min="0" step="0.1">
        <span class="help-block with-errors"></span>
    </div>
</div>
