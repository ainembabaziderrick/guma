            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="agent_name" class="col-lg-2 col-lg-offset-1 control-label">Agent Name</label>
                        <div class="col-lg-6">
                            <input type="text" name="agent_name" id="agent_name" class="form-control" required autofocus>
