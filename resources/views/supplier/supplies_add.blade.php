        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action=" {{ url('supplies/add')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field()}}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="total" class="form-control" required><br>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="paid" class="form-control" required><br>
                            </div>
                        </div>
